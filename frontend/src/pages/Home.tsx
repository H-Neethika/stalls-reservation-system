...
import { BookOpen, Users, Building2, Calendar } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { useAuth } from "@/contexts/AuthContext";

const literaryGenres = [
  { name: "Fiction", icon: "📚", description: "Novels and short stories" },
  { name: "Non-Fiction", icon: "📖", description: "Biography, history, and more" },
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Sri Lanka's largest book fair and exhibition. Reserve your stall today and showcase your books to thousands of readers.
          </p>
          ...
          {!user ? (
            ...
            <Button 
              size="lg" 
              onClick={() => navigate(userRole === "organizer" ? "/organizer/dashboard" : "/halls")}
              className="text-lg px-8"
            >
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <Card className="text-center hover-scale">
            <CardHeader>
              ...
              <CardDescription>Custom designed exhibition spaces</CardDescription>
            </CardHeader>
          </Card>
          <Card className="text-center hover-scale">
            <CardHeader>
      ...
      <section className="container mx-auto px-4 py-20">
        <Card className="bg-gradient-to-r from-primary/10 to-accent/10 border-0">
          <CardContent className="p-12 text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to Reserve Your Stall?</h2>
            <p className="text-muted-foreground mb-8 text-lg max-w-2xl mx-auto">
              Join hundreds of book publishers and vendors at Sri Lanka's premier book fair. 
              Easy online booking with instant confirmation and QR code generation.
            </p>
            <Button 
              size="lg" 
